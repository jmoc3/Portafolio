  ...
  return (
    <div className="leftSide sticky top-5 z-0 flex flex-col justify-between w-96 h-3/4vh pt-24 select-none">
      <div className="personalPitch flex flex-col gap-5 ">
        ...
        <span className="mini-description text-lg" data-value="Desarrollo soluciones tecnologicas basadas en datos y todo lo que estas puedan comunicar.">Desarrollo soluciones tecnologicas a problema cotidianos y no tan cotidianos en el son de ser un "Hombre que resulve".</span>
      </div>
